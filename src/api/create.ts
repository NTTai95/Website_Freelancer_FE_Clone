...
export const apiCreateSkill = async (data: RequestForm.Skill): Promise<AxiosResponse<void>> => {
    return await apiPost<void>(EndPoint.Admin.Skill.BASE, data);
};

export const apiCreateLanguage = async (data: RequestForm.Language): Promise<AxiosResponse<void>> => {
    return await apiPost<void>(EndPoint.Admin.Language.BASE, data);
};

export const apiCreateRole = async (data: RequestForm.Role): Promise<AxiosResponse<void>> => {
