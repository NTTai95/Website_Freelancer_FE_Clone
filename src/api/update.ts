...
export const apiUpdateSkill = async ({ id, data }: { id: number, data: RequestForm.Skill }): Promise<AxiosResponse<void>> => {
    return await apiPut<void>(EndPoint.Admin.Skill.ID.replace("{id}", id.toString()), data);
};

export const apiUpdateMajor = async ({ id, data }: { id: number, data: RequestForm.Major }): Promise<AxiosResponse<void>> => {
    return await apiPut<void>(EndPoint.Admin.Major.ID.replace("{id}", id.toString()), data);
};

export const apiUpdateLanguage = async ({ id, data }: { id: number, data: RequestForm.Language }): Promise<AxiosResponse<void>> => {
    return await apiPut<void>(EndPoint.Admin.Language.ID.replace("{id}", id.toString()), data);
};

export const apiUpdateRole = async ({ id, data }: { id: number, data: RequestForm.Role }): Promise<AxiosResponse<void>> => {
    return await apiPut<void>(EndPoint.Admin.Role.ID.replace("{id}", id.toString()), data);
};

export const apiUpdateJobStep1 = async ({ id, data }: { id: number, data: RequestForm.JobStep1 }): Promise<AxiosResponse<void>> => {
    return await apiPut<void>(EndPoint.Job.Step1.ID.replace("{id}", id.toString()), data);
};

export const apiUpdateJobStep2 = async ({ id, data }: { id: number, data: RequestForm.JobStep2 }): Promise<AxiosResponse<void>> => {
    return await apiPut<void>(EndPoint.Job.Step2.ID.replace("{id}", id.toString()), data);
};

export const apiUpdateJobStep3 = async ({ id, data }: { id: number, data: RequestForm.JobStep3 }): Promise<AxiosResponse<void>> => {
