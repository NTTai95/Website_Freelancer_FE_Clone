...
export default function EmployerMilestonesPage() {
                                    ...
                                    <Space size="large" wrap>
                                        ...
                                        {data.job && (
                                            <div style={{
                                                ...
                                                border: `1px solid ${data.job.status === 'COMPLETED' ? '#bfdbfe' :
                                                ...
                                                alignItems: 'center',
                                                gap: '8px',
                                                boxShadow: `0 2px 4px ${data.job.status === 'COMPLETED' ? 'rgba(53, 90, 142, 0.15)' :
