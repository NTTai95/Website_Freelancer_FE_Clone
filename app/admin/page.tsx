      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="dashboard-card bg-[#1e2c4a] border-[#2a3c5e] text-white">
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-gray-400">
              ...
              <span className="text-emerald-500 font-medium">+12.5%</span> so
              với tháng trước
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="dashboard-card bg-[#1e2c4a] border-[#2a3c5e] text-white">
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-gray-400">
              <ArrowUpRight className="mr-1 h-3 w-3 text-emerald-500" />
              <span className="text-emerald-500 font-medium">+8.2%</span> so với
              tháng trước
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="dashboard-card bg-[#1e2c4a] border-[#2a3c5e] text-white">
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-gray-400">
              <ArrowUpRight className="mr-1 h-3 w-3 text-emerald-500" />
              <span className="text-emerald-500 font-medium">+5.3%</span> so với
              tháng trước
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="dashboard-card bg-[#1e2c4a] border-[#2a3c5e] text-white">
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-gray-400">
              ...
              <span className="text-red-500 font-medium">-2.5%</span> so với
              tháng trước
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3 dashboard-card bg-[#1e2c4a] border-[#2a3c5e] text-white">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">
              Số lượng freelancer theo chuyên ngành
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="chart-container space-y-4">
              {[
                ...
                <div key={item.name} className="flex items-center">
                  <div className="w-full max-w-[180px] text-sm font-medium">
                    {item.name}
                  </div>
                  ...
                  <div className="ml-4 w-12 text-right text-sm">
                    {item.value}%
                  </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="dashboard-card bg-[#1e2c4a] border-[#2a3c5e] text-white">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">
              Ngôn ngữ được freelancer sử dụng nhiều nhất
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card className="dashboard-card bg-[#1e2c4a] border-[#2a3c5e] text-white">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">
              Kỹ năng được freelancer sử dụng nhiều nhất
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
